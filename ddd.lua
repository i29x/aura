			...
			Sections = {
				{
					...
					Options = {
						...
						{Type = "toggle", Name = "Gun Trespasser", Description = "if you use this a lot, admins u can get demoted dont troll a lot", Callback = "SetGunTrespasser", Default = false},
				...
				{
					Name = "Abyss Buttons",
					Description = "Extra placeholders",
					Options = {
